...
public class Constants {
    public static class Frame {
        ...
        public static final String ANALYSIS_FRAME_TITLE_KEY = "frame.analysis.title";
        public static final String ANALYSIS_TOTAL_COUNT_TEXT_KEY = "frame.analysis.totalcount.text";
    }
    ...
    public static class Location {
        public static final String MAIN_FRAME_VIEW_LOCATION = "demography/view/main.fxml";
        public static final String ANALYSIS_FRAME_VIEW_LOCATION = "demography/view/analysis.fxml";
    }

    public static class Misc {
        public static final String ANONYMOUS_FILE_NAME_KEY = "misc.anonymousfile.name";
    }
}
